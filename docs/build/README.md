...
- [`build.md`](build.md) — the `01`→`04` pipeline and prerequisites, **the kernel-as-RPM mechanism (#59/#77), and the RPM accounting** (every byte on the box, named). **Start here.**
