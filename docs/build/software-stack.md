...
ENV 1 — HOST (ours, the swapped layer)
  ...
  kernel                   6.18.37      upstream mainline, 64k pages, ZERO patches  (the shipped kernel; parity was benched on 6.18.34/4k — see build.md + platform-deltas.md)
...
| **Kernel** | `6.17.0-1021-nvidia` (vendored, NVIDIA-patched, gcc 13.3.0) | **stock upstream 6.18.37, ZERO patches, 64k pages** (gcc 14.3.1) — parity benched on `6.18.34`/4k | **OURS** — vendor kernel → stock mainline + our 64k page-size choice |
