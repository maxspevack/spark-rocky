...
What the zero-patch stack (Rocky 10.2 + stock 6.18 + open 610) has reproduced, and what's next. The shipped stack is now **6.18.35-64k**; the parity receipts below were benched on 6.18.34/4k (the 64k page-size win is in [`../build/platform-deltas.md`](../build/platform-deltas.md)). Each target
