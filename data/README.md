...
| `published-raw-Qwen3.5-35B-A3B-FP8-28879af7.md` | The **full published `llama-benchy` matrix** for the Qwen3.5-35B-A3B-FP8 entry (`tg128 (c1)` = 50.75). The reference we compare our reproduction to. |
...
```bash
./fetch.sh sub1772533296511    # Qwen3.5-35B-A3B-FP8  -> raw + recipe
./fetch.sh sub1777633319098    # Qwen3.5-0.8B
```
