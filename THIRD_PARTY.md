...
| [`spark-arena/sparkrun`](https://github.com/spark-arena/sparkrun) | official runner + `arena benchmark` submission CLI | adoption in **#72** (not yet consumed on the box) | none yet — the pin lands in `serving-images.env` with #72 validation |
